...
const headWeatherByCity = async ({ city }: GetWeatherByCityParams) => {
...
export const headWeatherByCityQuery = (params: GetWeatherByCityParams) =>
  queryOptions({
    queryKey: ["getWeatherByCity", params],
    queryFn: () => headWeatherByCity(params),
  });
